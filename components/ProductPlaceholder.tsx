    ...
    return (
        ...
        >
            ...
            <foreignObject x="0" y="0" width="100%" height="100%">
                {/* FIX: Removed the `xmlns` attribute to resolve a TypeScript error. The `div` inside a
                    `foreignObject` is still rendered as HTML by modern browsers without this attribute. */}
                <div 
                    style={{
                        display: 'flex',
